...
class _HomePageState extends State<HomePage> {
  ...
  setUpALan() {
    AlanVoice.addButton(
        "24249bd7da14f0b94f0ed2c71ff327202e956eca572e1d8b807a3e2338fdd0dc/stage",
      ...
      body: Stack(
        children: [
          ...
          [
            ...
            "Say - Hey Alan 😋".text.semiBold.white.make(),
          ].vStack(),
          radios != null
              ? VxSwiper.builder(
                  itemCount: radios.length == null ? 10 : radios.length,
                  aspectRatio: 1.0,
